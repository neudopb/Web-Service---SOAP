 ...
 * 
 */
@WebServiceClient(name = "ConversorService", targetNamespace = "http://soap/", wsdlLocation = "http://localhost:8000/conversor?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CONVERSORSERVICE_QNAME = new QName("http://soap/", "ConversorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8000/conversor?wsdl");
    ...
    public Conversor getConversorPort() {
        return super.getPort(new QName("http://soap/", "ConversorPort"), Conversor.class);
    }
    ...
    public Conversor getConversorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap/", "ConversorPort"), Conversor.class, features);
    }
